...
export const BANANA_ANALYSIS_USER_PROMPT =
  "Analyze this banana's ripeness. Respond with JSON only.";

export const RIPENESS_CONFIG = {
  UNRIPE: {
    label: "Unripe",
    emoji: "🟢",
    color: "#22C55E",
    ...
    tip: "Leave on the counter. Store at room temperature to ripen naturally.",
  },
  NEARLY_RIPE: {
    label: "Nearly Ripe",
    emoji: "🟡",
  ...
  OVERRIPE: {
    ...
    tip: "Time to bake! Perfect for banana bread or smoothies.",
  },
} as const;
